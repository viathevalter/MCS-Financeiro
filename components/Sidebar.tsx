  ...
  return (
    <div className="w-64 bg-brand-dark text-white flex flex-col h-screen fixed left-0 top-0 overflow-y-auto z-20">
      ...
      <div className="p-4 border-t border-gray-700">
        <Link to="/settings" className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${isActive('/settings') ? 'bg-white/10 text-brand-action font-medium' : 'text-gray-300 hover:bg-white/5'}`}>
          <Settings size={20} />
          Configurações
        </Link>
      </div>
